...
function loadCSV{
    Try{
 $global:users = Import-CSV $filePath -Header "UserPrincipalName", "Login", "Password","NewUserPrincipalName" |Select-Object -Skip 1
...
Elseif ($rnd_Button6.checked -eq $true)   {removeAllLicenses}
